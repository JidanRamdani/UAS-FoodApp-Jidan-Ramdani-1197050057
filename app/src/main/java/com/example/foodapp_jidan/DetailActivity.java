...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<com.example.foodapp_jidan.Food> list = com.example.foodapp_jidan.ListFood.getData(getApplicationContext());
        com.example.foodapp_jidan.Food food = list.get(id);
